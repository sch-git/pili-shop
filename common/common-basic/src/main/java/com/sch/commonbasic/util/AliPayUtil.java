...
public class AliPayUtil {
    ...
    public static String notify_url = "http://localhost:8099/order/notify";
    ...
    public static String ResponseForm(String code, BigDecimal total, String name) {
        // 初始化
        AlipayClient alipayClient = new DefaultAlipayClient(gatewayUrl, app_id, app_private_key, "json"
        ...
        String form = "";
        try {
            form = gatewayUrl + "?" + alipayClient.sdkExecute(alipayRequest).getBody();
